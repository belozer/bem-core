modules.define(
    'spec',
    ['i-bem-4', 'i-bem-dom', 'i-bem-dom__collection', 'objects', 'functions', 'jquery', 'chai', 'sinon', 'BEMHTML'],
...
describe('i-bem-dom', function() {
    ...
    describe('old events support', function() {
        it('should subscribe using \'on\' method', function() {
            var spy = sinon.spy(),
                Block = bemDom.declBlock('block'),
                block = initDom({ block : 'block' }).bem(Block);
        ...
        it('should subscribe using \'once\' method', function() {
            var spy = sinon.spy(),
                Block = bemDom.declBlock('block'),
                block = initDom({ block : 'block' }).bem(Block);

            block.once('click', spy);
            block._emit('click');
            block._emit('click');
