modules.define(
    'spec',
    ['i-bem-4', 'i-bem-dom', 'i-bem__dom', 'objects', 'events', 'jquery', 'chai', 'sinon', 'BEMHTML'],
    function(provide, bem, bemDom, BEMDOM, objects, events, $, chai, sinon, BEMHTML) {
...
describe('BEM events', function() {
    ...
    describe('on instance events', function() {
        ...
        describe('BEMDOM block instance events', function() {
            var block4, block3, Block3, Block4;
            beforeEach(function() {
                Block4 = bemDom.declBlock('block4', {
                    onSetMod : {
                        'js' : {
                            'inited' : function() {
                                this._events(block3 = this.findChildBlock(Block3))
                                    .on('click', spy1)
                                    .on('click', spy2)
                                    .on('click', data, wrapSpy(spy3));
                            }
            ...
            it('should properly bind handlers', function() {
                ...
                spy3.should.have.been.calledOn(block4);
                spy3.args[0][0].should.be.instanceOf(events.Event);
                spy3.args[0][1].should.be.equal(block3);
            ...
            it('should properly unbind all handlers', function() {
                block4._events(block3).un('click');
                block3.emit('click');
            ...
            it('should properly unbind specified handler', function() {
                block4._events(block3).un('click', spy1);
                block3.emit('click');
